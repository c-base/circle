...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Participant.check_in'
        db.alter_column(u'circleapp_participant', 'check_in', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=None))

        # Changing field 'Guest.check_in'
        db.alter_column(u'circleapp_guest', 'check_in', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=None))

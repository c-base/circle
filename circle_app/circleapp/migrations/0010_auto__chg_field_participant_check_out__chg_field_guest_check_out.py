...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Participant.check_out'
        db.alter_column(u'circleapp_participant', 'check_out', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'Guest.check_out'
        db.alter_column(u'circleapp_guest', 'check_out', self.gf('django.db.models.fields.DateTimeField')(default=None))

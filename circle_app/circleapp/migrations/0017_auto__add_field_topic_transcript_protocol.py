...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.transcript_protocol'
        db.add_column(u'circleapp_topic', 'transcript_protocol',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.transcript_protocol'
        db.delete_column(u'circleapp_topic', 'transcript_protocol')

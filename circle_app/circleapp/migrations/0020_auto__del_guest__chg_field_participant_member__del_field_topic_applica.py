...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participant.member'
        db.alter_column(u'circleapp_participant', 'member_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        ...
        db.add_column(u'circleapp_topic', 'applicant',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='topic_applications', null=True, to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'Topic.sponsor'
        db.alter_column(u'circleapp_topic', 'sponsor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Participant.member'
        db.alter_column(u'circleapp_participant', 'member_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['circle.Member']))
        # Adding field 'Topic.applicant_member'
        db.add_column(u'circleapp_topic', 'applicant_member',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='topic_applications', null=True, to=orm['circle.Member'], blank=True),
                      keep_default=False)

        # Adding field 'Topic.applicant_alien'
        db.add_column(u'circleapp_topic', 'applicant_alien',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='topic_applications', null=True, to=orm['circle.Alien'], blank=True),
                      keep_default=False)

        # Deleting field 'Topic.applicant'
        db.delete_column(u'circleapp_topic', 'applicant_id')
    ...
    models = {
        ...
        u'circleapp.participant': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'participations'", 'to': u"orm['auth.User']"}),

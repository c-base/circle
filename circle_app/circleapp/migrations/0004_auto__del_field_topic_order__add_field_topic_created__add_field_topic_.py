...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Topic.order'
        db.delete_column(u'circleapp_topic', 'order')

        # Adding field 'Topic.created'
        db.add_column(u'circleapp_topic', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 10, 11, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Topic.uuid'
        db.add_column(u'circleapp_topic', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=36),
                      keep_default=False)


        # Changing field 'Topic.sponsor'
        db.alter_column(u'circleapp_topic', 'sponsor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['circle.Member']))

        # Changing field 'Topic.circle'
        db.alter_column(u'circleapp_topic', 'circle_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['circleapp.Circle']))

    def backwards(self, orm):
        # Adding field 'Topic.order'
        db.add_column(u'circleapp_topic', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Topic.created'
        db.delete_column(u'circleapp_topic', 'created')

        # Deleting field 'Topic.uuid'
        db.delete_column(u'circleapp_topic', 'uuid')


        # Changing field 'Topic.sponsor'
        db.alter_column(u'circleapp_topic', 'sponsor_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['circle.Member']))

        # Changing field 'Topic.circle'
        db.alter_column(u'circleapp_topic', 'circle_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['circleapp.Circle']))
    ...
    models = {
        ...
        u'circleapp.topic': {
            ...
            'circle': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'topics'", 'null': 'True', 'to': u"orm['circleapp.Circle']"}),
            'closed': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),

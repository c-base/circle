...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participant.check_in'
        db.alter_column(u'circleapp_participant', 'check_in', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Participant.check_out'
        db.alter_column(u'circleapp_participant', 'check_out', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Guest.check_out'
        db.alter_column(u'circleapp_guest', 'check_out', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Guest.check_in'
        db.alter_column(u'circleapp_guest', 'check_in', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Participant.check_in'
        db.alter_column(u'circleapp_participant', 'check_in', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Participant.check_out'
        db.alter_column(u'circleapp_participant', 'check_out', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Guest.check_out'
        db.alter_column(u'circleapp_guest', 'check_out', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Guest.check_in'
        db.alter_column(u'circleapp_guest', 'check_in', self.gf('django.db.models.fields.DateTimeField')(null=True))

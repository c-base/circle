...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.email'
        db.add_column(u'circleapp_topic', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='foo@bar', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.email'
        db.delete_column(u'circleapp_topic', 'email')

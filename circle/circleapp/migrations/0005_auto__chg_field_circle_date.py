...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Circle.date'
        db.alter_column(u'circleapp_circle', 'date', self.gf('django.db.models.fields.DateField')(unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Circle.date'
        db.alter_column(u'circleapp_circle', 'date', self.gf('django.db.models.fields.DateField')(default=None, unique=True))

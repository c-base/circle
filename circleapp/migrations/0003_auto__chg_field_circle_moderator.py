...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Circle.moderator'
        db.alter_column(u'circleapp_circle', 'moderator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['circle.Member']))

    def backwards(self, orm):

        # Changing field 'Circle.moderator'
        db.alter_column(u'circleapp_circle', 'moderator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['circle.Member']))
